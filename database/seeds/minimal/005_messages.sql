...
CASE WHEN n%2=0 THEN 'Outbound' ELSE 'Inbound' END, 'Text', 'Mensagem fictícia minimal ' || n, 'Mensagem fictícia minimal ' || n, :'whatsapp_provider', 'SM_TEST_MINIMAL_' || lpad(n::text,4,'0'), CASE WHEN n%2=0 THEN 'Sent' ELSE 'Received' END,
