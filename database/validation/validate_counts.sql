...
BEGIN
  ...
  IF current_setting('test_data.profile', true) = 'e2e' THEN
    -- The E2E profile contains six users in the main tenant and one in the
    -- isolated tenant; this includes the platform administrator used by the
    -- onboarding scenarios.
    IF (SELECT count(*) FROM clinic_assistant.users WHERE "TenantId" IN ('00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000102')) <> 7 THEN RAISE EXCEPTION 'Expected 7 E2E users.'; END IF;
