...
public sealed record TwilioSendTextRequest(string To, string From, string Body, string? MessagingServiceSid, string? StatusCallbackUrl = null);
public sealed record TwilioSendTemplateRequest(string To, string From, string ContentSid, IReadOnlyDictionary<string, string> Variables, string? MessagingServiceSid, string? StatusCallbackUrl = null);
public sealed record TwilioSendMediaRequest(string To, string From, string MediaUrl, string? Caption, string? MessagingServiceSid, string? StatusCallbackUrl = null);
