...
type Auth = { user: User | null; token: string | null; realtimeStatus: "offline" | "connecting" | "online"; login: (email: string, password: string) => Promise<void>; logout: () => Promise<void> };
