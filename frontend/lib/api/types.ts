...
export type DemoLead = { id: string; fullName: string; companyOrClinicName: string; email: string; phone: string; status: string; source: string; assignedToUserId?: string | null; createdAt: string; lastContactAt?: string | null; nextActionAt?: string | null; nextActionDescription?: string | null; utmSource?: string | null; utmMedium?: string | null; utmCampaign?: string | null; utmContent?: string | null; utmTerm?: string | null; landingPage?: string | null; referrer?: string | null };
export type DemoLeadPage = PagedResult<DemoLead>;
export type DemoLeadSummary = { new: number; contacted: number; qualified: number; demoScheduled: number; demoCompleted: number; pilot: number; won: number; lost: number; archived: number; total: number };
