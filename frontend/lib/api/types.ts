...
export type DemoLead = { id: string; fullName: string; companyOrClinicName: string; email: string; phone: string; status: string; source: string; assignedToUserId?: string | null; createdAt: string; lastContactAt?: string | null; utmSource?: string | null; utmMedium?: string | null; utmCampaign?: string | null; utmContent?: string | null; utmTerm?: string | null; landingPage?: string | null; referrer?: string | null };
