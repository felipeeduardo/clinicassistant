...
const clinicSchema = z.object({ legalName: text("a razão social"), tradeName: text("o nome fantasia"), document: text("o documento"), email: z.string().email("Informe um e-mail válido."), phone: text("o telefone"), timeZone: text("o fuso horário"), assistantDisplayName: z.string().trim().max(60, "Use no máximo 60 caracteres.").nullable().optional() });
