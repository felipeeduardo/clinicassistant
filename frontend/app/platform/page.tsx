...
export default function PlatformPage() {
  ...
  return <ProtectedShell><PageContainer>
    <PageHeader actions={<div className="flex flex-wrap gap-2"><Button variant="outline" onClick={() => { window.location.href = "/platform/leads" }}>Leads comerciais</Button><Button onClick={() => { window.location.href = "/platform/onboarding" }}>{hasClinics ? "Nova clínica" : "Configurar primeira clínica"}</Button></div>} description="Acompanhe os tenants e configure clínicas com um fluxo guiado." pathname="/platform" title="Administração da plataforma" />
