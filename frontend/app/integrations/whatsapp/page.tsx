...
function friendlyOperationError(error: unknown) {
  ...
  const messages: Record<string, string> = { invalid_operation: "A integração não está pronta. Valide a configuração e confirme se o provider está habilitado.", resource_not_found: "Nenhuma integração WhatsApp foi encontrada para este tenant.", unauthorized: "Seu usuário não tem permissão para operar a integração." };
