...
export default function AuditPage() {
  ...
  const audit = useQuery({ enabled: allowed, placeholderData: keepPreviousData, queryKey: ["audit", page, debouncedAction, debouncedResourceType], queryFn: () => auditApi.search(api, { page, pageSize: 100, action: debouncedAction, resourceType: debouncedResourceType }) });
