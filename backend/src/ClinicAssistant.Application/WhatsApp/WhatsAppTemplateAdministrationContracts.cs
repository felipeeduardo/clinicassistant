...
public sealed record WhatsAppTemplateQuery(int Page = 1, int PageSize = 25, string? Search = null, string? Status = null, string? LanguageCode = null, string? Category = null);
public sealed record WhatsAppTemplateListItem(Guid Id, string Name, string LanguageCode, string? Category, string Status, string ContentSidMasked, DateTimeOffset UpdatedAt);
public sealed record WhatsAppTemplateDetail(Guid Id, string Name, string LanguageCode, string? Category, string Status, string ContentSidMasked, IReadOnlyList<string> Variables, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt);
